...
$_['entry_tax_Cliente']           = 'Use Cliente Tax Address:<br /><span class="help">Use the Clientes default address when they login to calculate taxes. You can choose to use the default address for the Clientes shipping or Dirección de facturación.</span>';
$_['entry_Cliente_group']         = 'Cliente Group:<br /><span class="help">Default Cliente group.</span>';
$_['entry_Cliente_group_display'] = 'Cliente Groups:<br /><span class="help">Display Cliente groups that new Clientes can select to use such as wholesale and business when signing up.</span>';
$_['entry_Cliente_price']         = 'Login Display Prices:<br /><span class="help">Only show prices when a Cliente is logged in.</span>';
...
$_['entry_image_Categoría']         = 'Categoría Image Size:';
...
$_['error_Cliente_group_display'] = 'You must include the default Cliente group if you are going to use this feature!';
...
$_['error_image_Categoría']         = 'Categoría List Size dimensions required!';
...
$_['error_Tienda']                  = 'Atención: This Tienda cannot be deleted as it is currently assigned to %s orders!';
?>