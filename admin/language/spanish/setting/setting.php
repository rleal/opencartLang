...
$_['entry_currency_auto']          = 'Auto Update Currency:<br /><span class="help">Set your Tienda to automatically update currencies daily.</span>';
...
$_['entry_admin_limit']   	       = 'Default Items Per Page (Admin):<br /><span class="help">Determines how many admin items are shown per page (orders, Clientes, etc)</span>';
$_['entry_product_count']          = 'Categoría Product Count:<br /><span class="help">Show the number of Productos inside the subcategories in the Tiendafront header Categoría menu. Be warned, this will cause an extreme performance hit for Tiendas with a lot of subcategories!</span>';
...
$_['entry_voucher_min']            = 'Voucher Min:<br /><span class="help">Minimum Importe a Cliente can purchase a voucher for.</span>';
$_['entry_voucher_max']            = 'Voucher Max:<br /><span class="help">Maximum Importe a Cliente can purchase a voucher for.</span>';
...
$_['entry_order_edit']             = 'Order Editing:<br /><span class="help">Number of days allowed to edit an order. This is required because prices and Descuentos may change over time corrupting the order if its edited.</span>';
...
$_['entry_complete_status']        = 'Complete Order Status:<br /><span class="help">Set the order status the Clientes order must reach before they are allowed to access their downloadable Productos and gift vouchers.</span>';
$_['entry_stock_display']          = 'Display Stock:<br /><span class="help">Display stock quantity on the product page.</span>';
$_['entry_stock_warning']          = 'Show Out Of Stock Atención:<br /><span class="help">Display out of stock message on the shopping cart page if a product is out of stock but stock checkout is yes. (Warning always shows if stock checkout is no)</span>';
...
$_['entry_mail_parameter']         = 'Mail Parameters:<span class="help">When using \'Mail\', additional mail parameters can be added here (e.g. "-femail@Tiendaaddress.com".';
...
$_['entry_account_mail']           = 'New Account Alert Mail:<br /><span class="help">Send a email to the Tienda owner when a new account is registered.</span>';
$_['entry_alert_mail']             = 'New Order Alert Mail:<br /><span class="help">Send a email to the Tienda owner when a new order is created.</span>';
$_['entry_alert_emails']           = 'Additional Alert E-Mails:<br /><span class="help">Any additional emails you want to receive the alert email, in addition to the main Tienda email. (comma separated)</span>';
...
$_['entry_maintenance']            = 'Maintenance Mode:<br /><span class="help">Prevents Clientes from browsing your Tienda. They will instead see a maintenance message. If logged in as admin, you will see the Tienda as normal.</span>';
...
$_['entry_google_analytics']       = 'Google Analytics Código:<br /><span class="help">Login to your <a onclick="window.open(\'http://www.google.com/analytics/\');"><u>Google Analytics</u></a> account and after creating your web site profile copy and paste the analytics Código into this field.</span>';

// Error
$_['error_warning']                = 'Atención: Please check the form carefully for errors!';
$_['error_permission']             = 'Atención: No tienes permisos para modificar settings!';
...
$_['error_voucher_min']            = 'Minimum voucher Importe required!';
$_['error_voucher_max']            = 'Maximum voucher Importe required!';
