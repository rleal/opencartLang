...
$_['text_customer_counter']        = 'Cliente Counter';
...
$_['text_suggested_retail_rates']  = 'Suggested Retail Rates (UPS Tienda)';
...
$_['entry_packaging']              = 'Packaging Tipo:<span class="help">What kind of packaging do you use?</span>';
$_['entry_classification']         = 'Cliente Classification Código:<span class="help">01 - If you are billing to a UPS account and have a daily UPS pickup, 03 - If you do not have a UPS account or you are billing to a UPS account but do not have a daily pickup, 04 - If you are shipping from a retail outlet (only used when origin is US)</span>';
$_['entry_origin']                 = 'Shipping Origin Código:<span class="help">What origin point should be used (this setting affects only what UPS product names are shown to the user)</span>';
$_['entry_city']                   = 'Origin City:<span class="help">Enter the name of the origin city.</span>';
$_['entry_state']                  = 'Origin State/Province:<span class="help">Enter the two-letter Código for your origin state/province.</span>';
$_['entry_country']                = 'Origin Country:<span class="help">Enter the two-letter Código for your origin country.</span>';
$_['entry_postCódigo']               = 'Origin Zip/Postal Código:<span class="help">Enter your origin zip/postalCódigo.</span>';
$_['entry_test']                   = 'Test Mode:<span class="help">Use this module in Test (YES) or Production mode (NO)?</span>';
$_['entry_quote_type']             = 'Quote Tipo:<span class="help">Quote for Residential or Commercial Delivery.</span>';
...
// Error
$_['error_permission']             = 'Atención: No tienes permisos para modificar UPS (US) shipping!';
